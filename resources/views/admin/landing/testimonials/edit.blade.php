...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin / Testimonials /</span> Edit Testimonial</h4>
        ...
        <div class="card-body">
          <form action="{{ route('admin.testimonials.update', $testimonial->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="role" name="role" value="{{ $testimonial->role }}" required />
            </div>
            ...
            <div class="mb-3">
               <label class="form-label" for="avatar_type">Avatar Source</label>
                ...
                <div class="mb-2">
                    <img src="{{ \Illuminate\Support\Str::startsWith($testimonial->avatar, 'http') ? $testimonial->avatar : asset($testimonial->avatar) }}" alt="Preview" class="d-block rounded" style="max-height: 50px; width: auto;">
                </div>
                @endif
               ...
               <div class="tab-content p-0">
                   <div class="tab-pane fade show active" id="navs-url">
                        <input type="text" class="form-control" id="avatar_input" name="avatar" value="{{ $testimonial->avatar }}" placeholder="https://..." />
