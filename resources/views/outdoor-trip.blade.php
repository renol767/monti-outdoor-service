...
<head>
  ...
  <style>
    ...
    .mt-hero .hero-bg {
      position: absolute;
      inset: 0;
      background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.6)), url("{{ asset('assets/img/front-pages/hero/outdoor-hero.jpg') }}") no-repeat bottom;
...
<body>
    ...
    <div class="container">
      <div class="header-content">
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="{{ route('outdoor-trip') }}" class="custom-dropdown-toggle dropdown-toggle active">
              Outdoor Activity Trip
              <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                <path d="M4 6L8 10L12 6H4Z"/>
              </svg>
  ...
  <!-- Hero Section -->
  @php
      $heroSection = $sections->firstWhere('slug', 'outdoor-hero');
      $displaySections = $sections->where('slug', '!=', 'outdoor-hero');
      
      // Default fallback
      $heroBg = asset('assets/img/front-pages/hero/outdoor-hero.jpg');
      $heroTitle = __('trip.outdoor');
      $heroSubtitle = __('content.hero.outdoor_trip.tagline');
  ...
  <section class="cta-section">
    <div class="container">
      <h3>{{ __('general.ready_for_outdoor_adventure') }}</h3>
      <p>{{ __('general.contact_for_outdoor_consultation') }}</p>
