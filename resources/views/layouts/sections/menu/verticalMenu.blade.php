...
<aside id="layout-menu" class="layout-menu menu-vertical menu" @foreach ($configData['menuAttributes'] as $attribute=>
  ...
  <div class="app-brand demo">
    <a href="{{ auth()->check() && auth()->user()->isAdmin() ? route('admin.dashboard') : (auth()->check() && auth()->user()->isUser() ? route('user.dashboard') : url('/')) }}" class="app-brand-link">
      <img src="{{ asset('images/logo/Untitled-4.png') }}" alt="Monti Outdoor" style="height: 40px;">
    </a>
