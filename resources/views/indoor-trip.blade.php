...
<body>
  ...
  <section class="mt-hero">
    ...
    <div class="hero-content container">
      ...
      <h1 class="mt-title">Aktivitas Indoor & Event</h1>
      <p class="mt-subtitle">Layanan profesional untuk gathering, event perusahaan, dan berbagai aktivitas indoor lainnya. Kami handle semuanya.</p>
    </div>
  </section>
  ...
  <section class="cta-section">
    <div class="container">
      <h3>Butuh Layanan Event Profesional?</h3>
      <p>Hubungi kami sekarang untuk konsultasi gratis dan dapatkan penawaran terbaik untuk kebutuhan event Anda.</p>
