...
<head>
  ...
  <!-- Primary Meta Tags -->
  <title>Mountain Trip - Pendakian Gunung Indonesia | Monti Outdoor Service</title>
  <meta name="title" content="Mountain Trip - Pendakian Gunung Indonesia | Monti Outdoor Service">
  <meta name="description" content="Paket pendakian gunung Indonesia: Private Trip, One Day Trip, Expedition Trip, International Trip. Guide profesional, peralatan lengkap, dan pengalaman tak terlupakan.">
  <meta name="keywords" content="mountain trip, pendakian gunung, hiking indonesia, private trip, expedition, gunung semeru, gunung rinjani, gunung bromo">
  ...
  <meta property="og:title" content="Mountain Trip - Pendakian Gunung Indonesia">
  <meta property="og:description" content="Paket pendakian gunung Indonesia dengan guide profesional dan peralatan lengkap.">
  ...
  <meta property="twitter:title" content="Mountain Trip - Pendakian Gunung Indonesia">
  <meta property="twitter:description" content="Paket pendakian gunung Indonesia dengan guide profesional dan peralatan lengkap.">
...
<body>
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu">
              ...
              <a href="{{ route('mountain-trip') }}#{{ $section->slug }}" class="dropdown-item">{{ $section->title }}</a>
              @endforeach
            </div>
          </div>
  ...
  <!-- Hero Section -->
  @php
      $heroSection = $sections->firstWhere('slug', 'mountain-hero');
      $displaySections = $sections->where('slug', '!=', 'mountain-hero');
      
      // Default fallback
      $heroBg = asset('assets/img/front-pages/hero/mountain-hero.jpg');
      $heroTitle = __('trip.mountain');
      $heroSubtitle = __('content.hero.mountain_trip.tagline');
      
      if ($heroSection) {
          if ($heroSection->image) $heroBg = asset($heroSection->image); // Assuming 'image' attribute or access method
  ...
  <section class="mt-hero">
    ...
    <div class="hero-content container">
      <span class="mt-badge">Mountain Trip</span>
    ...
    <div class="container">
      <div class="trip-section-grid">
        ...
        <div class="trip-content">
          ...
          <a href="{{ route('mountain-trip.detail', $section->slug) }}" class="btn-read-more">
  ...
  <section class="cta-section">
    <div class="container">
      <h3>{{ __('general.ready_for_adventure') }}</h3>
      <p>{{ __('general.contact_for_consultation') }}</p>
      <a href="https://wa.me/{{ $settings['global_whatsapp'] ?? '6281196969119' }}?text={{ urlencode('Halo Monti Outdoor! Saya tertarik dengan layanan Mountain Trip.') }}" target="_blank" class="btn-contact">
      ...
      <div class="footer-grid">
        <div class="footer-col">
          ...
          <div class="social-links mt-3">
            <a href="https://www.instagram.com/monti.outdoorservice/" target="_blank" class="social-link" title="Instagram">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
            </a>
            <a href="https://www.tiktok.com/@monti.outdoor.service" target="_blank" class="social-link" title="TikTok">
            ...
            <a href="https://www.youtube.com/@montioutdoorservice" target="_blank" class="social-link" title="YouTube">
