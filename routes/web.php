...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    // Services Resouce
    Route::resource('/services', App\Http\Controllers\Admin\LandingServiceController::class, ['as' => 'admin']);
    
    // Features Resource
    Route::resource('/features', App\Http\Controllers\Admin\LandingFeatureController::class, ['as' => 'admin']);
